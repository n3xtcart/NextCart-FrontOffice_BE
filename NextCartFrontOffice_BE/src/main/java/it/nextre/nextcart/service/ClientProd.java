...
public class ClientProd implements ServizioProdotto {
	...
	public ClientProd() {
	        ...
	        // Carne
			CategoriaDTO carne = clientCat.trovaPerNome("Carne").get();
	        ...
	        // Frutta & Verdura
			CategoriaDTO fruttaVerdura = clientCat.trovaPerNome("Frutta & Verdura").get();
	        ...
	        // Uova & Latticini
			CategoriaDTO uovaLatticini = clientCat.trovaPerNome("Uova & Latticini").get();
	        ...
	        // Igiene
			CategoriaDTO igiene = clientCat.trovaPerNome("Igiene").get();
	        ...
	        // Salumi & Formaggi
			CategoriaDTO salumiForm = clientCat.trovaPerNome("Salumi & Formaggi").get();
	        ...
	        // Pesce
			CategoriaDTO pesce = clientCat.trovaPerNome("Pesce").get();
